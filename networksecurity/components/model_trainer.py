...
class ModelTrainer:
    def __init__(self,model_trainer_config:ModelTrainerConfig,
        ...
        try:
            #We store these objects inside the class so that all methods of this class can use them later.
    ...
    def train_model(self,X_train,y_train,X_test,y_test):
        ...
        ## to gt best model name form dict
        ...
        ## Track the experiment of differnt model and  mlflow
        self.track_mlflow(best_model,get_classification_score(y_true=y_train,y_pred=y_train_pred))
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            #loading traing array and testing arra
